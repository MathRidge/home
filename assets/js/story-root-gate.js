(function () {
  ...
  function chapterTwoFrames() {
    return [
      ...
      { bg: "rootGateOpen", sprite: "miraHappy", elder: "elder", speaker: "Narrator", text: "Mira stood beside you, holding her certificate with both hands. She had been staring at it for several minutes." },
      { bg: "rootGateOpen", sprite: "miraHappy", elder: "elder", speaker: "Mira", text: "I keep checking." },
      { bg: "rootGateOpen", sprite: "miraNeutral", elder: "elder", speaker: "You", text: "Checking what?" },
      { bg: "rootGateOpen", sprite: "miraHappy", elder: "elder", speaker: "Mira", text: "That it still says I passed. It does." },
      { bg: "rootGateOpen", sprite: "miraNeutral", elder: "elder", speaker: "Narrator", text: "A pause." },
      { bg: "rootGateOpen", sprite: "miraHappy", elder: "elder", speaker: "Mira", text: "I checked seven times." },
      { bg: "rootGateOpen", sprite: "miraNeutral", elder: "elder", speaker: "You", text: "That seems enough." },
      { bg: "rootGateOpen", sprite: "miraDetermined", elder: "elder", speaker: "Mira", text: "Eight is safer." },
      ...
      { bg: "rootGateOpen", sprite: "miraNeutral", elder: "elder", speaker: "You", text: "Not through the gate yet?" },
      { bg: "rootGateOpen", sprite: "miraNeutral", elder: "elder", speaker: "Elder Shellwick", text: "Not yet." },
      ...
      { bg: "cipherRidgeEvening", sprite: "miraHappy", elder: "none", speaker: "Narrator", text: "Mira walked very carefully, still holding her certificate." },
      { bg: "cipherRidgeEvening", sprite: "miraConfused", elder: "none", speaker: "Narrator", text: "Then she tripped over nothing. You caught the back of her cloak before she fell." },
      ...
      { bg: "emptyRelicTable", sprite: "miraHappy", elder: "elder", speaker: "Mira", text: "I would still like to keep mine in my pack." },
      ...
      { bg: "visionRelicCase", sprite: "miraConfused", elder: "elder", speaker: "Mira", text: "Were those...", relicReveal: "lights" },
      { bg: "visionRelicCase", sprite: "miraNeutral", elder: "elder", speaker: "You", text: "More relics?", relicReveal: "lights" },
      { bg: "visionRelicCase", sprite: "miraNeutral", elder: "elder", speaker: "Elder Shellwick", text: "Yes.", relicReveal: "lights" },
      { bg: "visionRelicCase", sprite: "miraHappy", elder: "elder", speaker: "Mira", text: "Are they like the first four?", relicReveal: "lights" },
      { bg: "visionRelicCase", sprite: "miraNeutral", elder: "elder", speaker: "Elder Shellwick", text: "No.", relicReveal: "lights" },
      ...
      { bg: "visionRelicCase", sprite: "miraConfused", elder: "elder", speaker: "Mira", text: "Do they give us magical glasses?", relicReveal: "lights" },
      { bg: "visionRelicCase", sprite: "miraConfused", elder: "elder", speaker: "Elder Shellwick", text: "No.", relicReveal: "lights" },
      { bg: "visionRelicCase", sprite: "miraConfused", elder: "elder", speaker: "Mira", text: "Small glasses?", relicReveal: "lights" },
      { bg: "visionRelicCase", sprite: "miraConfused", elder: "elder", speaker: "Elder Shellwick", text: "No.", relicReveal: "lights" },
      { bg: "visionRelicCase", sprite: "miraConfused", elder: "elder", speaker: "Mira", text: "Tiny glasses for numbers?", relicReveal: "lights" },
      { bg: "visionRelicCase", sprite: "miraWorried", elder: "elder", speaker: "Elder Shellwick", text: "Mira.", relicReveal: "lights" },
      { bg: "visionRelicCase", sprite: "miraWorried", elder: "elder", speaker: "Mira", text: "Right. Not glasses.", relicReveal: "lights" },
      { bg: "visionRelicCase", sprite: "miraNeutral", elder: "elder", speaker: "Elder Shellwick", text: "The Vision Relics help you see what numbers are made of.", relicReveal: "lights" },
      ...
      { bg: "visionRelicCase", sprite: "miraNeutral", elder: "elder", speaker: "Elder Shellwick", text: "The Shelf Scale.", relicReveal: "term" },
      { bg: "visionRelicCase", sprite: "miraHappy", elder: "elder", speaker: "Mira", text: "That one looks friendly.", relicReveal: "term" },
      { bg: "visionRelicCase", sprite: "miraNeutral", elder: "elder", speaker: "You", text: "What does it do?", relicReveal: "term" },
      { bg: "visionRelicCase", sprite: "miraNeutral", elder: "elder", speaker: "Elder Shellwick", text: "It helps compare pieces and place them where they belong.", relicReveal: "term" },
      { bg: "visionRelicCase", sprite: "miraHappy", elder: "elder", speaker: "Mira", text: "So it is a very organized shelf.", relicReveal: "term" },
      { bg: "visionRelicCase", sprite: "miraNeutral", elder: "elder", speaker: "Elder Shellwick", text: "In a sense.", relicReveal: "term" },
      { bg: "visionRelicCase", sprite: "miraNeutral", elder: "elder", speaker: "Elder Shellwick", text: "The Primewood Seed.", relicReveal: "sign" },
      { bg: "visionRelicCase", sprite: "miraNeutral", elder: "elder", speaker: "Narrator", text: "The seed cracked open, showing smaller glowing factors inside.", relicReveal: "sign" },
      { bg: "visionRelicCase", sprite: "miraNeutral", elder: "elder", speaker: "You", text: "Primewood?", relicReveal: "sign" },
      { bg: "visionRelicCase", sprite: "miraNeutral", elder: "elder", speaker: "Elder Shellwick", text: "Some numbers grow from smaller roots.", relicReveal: "sign" },
      { bg: "visionRelicCase", sprite: "miraConfused", elder: "elder", speaker: "Mira", text: "Does it need water?", relicReveal: "sign" },
      { bg: "visionRelicCase", sprite: "miraConfused", elder: "elder", speaker: "Elder Shellwick", text: "No.", relicReveal: "sign" },
      { bg: "visionRelicCase", sprite: "miraConfused", elder: "elder", speaker: "Mira", text: "Sunlight?", relicReveal: "sign" },
      { bg: "visionRelicCase", sprite: "miraConfused", elder: "elder", speaker: "Elder Shellwick", text: "No.", relicReveal: "sign" },
      { bg: "visionRelicCase", sprite: "miraConfused", elder: "elder", speaker: "Mira", text: "Compliments?", relicReveal: "sign" },
      { bg: "visionRelicCase", sprite: "miraNeutral", elder: "elder", speaker: "Elder Shellwick", text: "Those are harmless.", relicReveal: "sign" },
      { bg: "visionRelicCase", sprite: "miraHappy", elder: "elder", speaker: "Mira", text: "You are doing very well.", relicReveal: "sign" },
      { bg: "visionRelicCase", sprite: "miraConfused", elder: "elder", speaker: "Narrator", text: "The seed flickered once. Mira's ears shot up.", relicReveal: "sign" },
      { bg: "visionRelicCase", sprite: "miraHappy", elder: "elder", speaker: "Mira", text: "It heard me.", relicReveal: "sign" },
      { bg: "visionRelicCase", sprite: "miraNeutral", elder: "elder", speaker: "Elder Shellwick", text: "It reflected light.", relicReveal: "sign" },
      { bg: "visionRelicCase", sprite: "miraHappy", elder: "elder", speaker: "Mira", text: "It heard me reflectively.", relicReveal: "sign" },
      { bg: "visionRelicCase", sprite: "miraNeutral", elder: "elder", speaker: "Narrator", text: "Shellwick decided not to argue.", relicReveal: "sign" },
      { bg: "visionRelicCase", sprite: "miraNeutral", elder: "elder", speaker: "Elder Shellwick", text: "The Fraction Loom.", relicReveal: "parity" },
      ...
      { bg: "visionRelicCase", sprite: "miraWorried", elder: "elder", speaker: "Mira", text: "Fractions. I have heard stories.", relicReveal: "parity" },
      { bg: "visionRelicCase", sprite: "miraNeutral", elder: "elder", speaker: "You", text: "Bad stories?", relicReveal: "parity" },
      { bg: "visionRelicCase", sprite: "miraWorried", elder: "elder", speaker: "Mira", text: "Half of them were bad. Which feels appropriate, but upsetting.", relicReveal: "parity" },
      { bg: "visionRelicCase", sprite: "miraNeutral", elder: "elder", speaker: "Elder Shellwick", text: "The loom does not harm the whole. It shows how the whole is woven.", relicReveal: "parity" },
      { bg: "visionRelicCase", sprite: "miraNeutral", elder: "elder", speaker: "Mira", text: "That sounds less terrifying.", relicReveal: "parity" },
      { bg: "visionRelicCase", sprite: "miraNeutral", elder: "elder", speaker: "You", text: "A little.", relicReveal: "parity" },
      { bg: "visionRelicCase", sprite: "miraNeutral", elder: "elder", speaker: "Elder Shellwick", text: "The Power Tally.", relicReveal: "factor" },
      ...
      { bg: "visionRelicCase", sprite: "miraNeutral", elder: "elder", speaker: "You", text: "That one looks... intense.", relicReveal: "factor" },
      { bg: "visionRelicCase", sprite: "miraNeutral", elder: "elder", speaker: "Elder Shellwick", text: "It records repeated growth.", relicReveal: "factor" },
      { bg: "visionRelicCase", sprite: "miraConfused", elder: "elder", speaker: "Mira", text: "So it counts numbers that are climbing on top of themselves?", relicReveal: "factor" },
