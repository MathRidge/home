(function () {
  ...
  const backgrounds = {
    ...
    primewoodGateExterior: `${chapterTwoBgBase}primewood-gate-exterior.png`,
    primewoodBridgePhone: `${chapterTwoBgBase}primewood-bridge-to-phone.png`,
    primewoodBridgeWarning: `${chapterTwoBgBase}primewood-bridge-warning-cracked.png`,
  ...
  const bridgeRevealCue = { file: "glitter-chime.mp3", start: 0, end: 2.6, volume: 0.3, fadeOut: 520, lockMs: 900 };
  const phoneSignalCue = { file: "magic ping.mp3", start: 0, end: 1.9, volume: 0.24, fadeOut: 420, lockMs: 620 };
  ...
  const sceneSoundCuesByText = new Map([
    ...
    ["The gate opened fully.", [{ file: "enchanted-spell-casting.mp3", start: 0, end: 1.55, volume: 0.32, fadeOut: 260, lockMs: 780 }]],
    ...
    ["The mountain wind moved through the gate. Far above, a faint blue light flickered. Your phone. Still out there. Still waiting.", [phoneSignalCue]],
    ["Higher up the mountain, something flashed blue. Once. Then again.", [phoneSignalCue]],
    ["Your phone. Still far away. Still waiting.", [phoneSignalCue]],
    ["Wait. My phone is up there.", [phoneSignalCue]],
    ["Your phone. Still higher. Still waiting.", [phoneSignalCue]],
    ["Far above the Root Gate, your phone flashed blue again.", [phoneSignalCue]],
    ...
    ["Beyond the gate, a thin bridge of light reached toward your phone.", [bridgeRevealCue]],
    ["The phone is right there.", [phoneSignalCue]],
    ["The unfinished shared 3 glowed red.", [gateLockCue]],
    ["The phone lifted farther into the blue light.", [phoneSignalCue]],
    ["Above it, a new gate flickered. Your phone's blue light waited behind it, farther now, but still visible.", [phoneSignalCue]],
